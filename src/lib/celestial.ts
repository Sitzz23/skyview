...
// From skylight (github.com/cpaczek/skylight, MIT).

import * as AstronomyNS from "astronomy-engine";
import * as satelliteNS from "satellite.js";
import { STARS } from "./stars";

// Both packages ship UMD/CJS bundles. Under some module loaders the ESM
// namespace only exposes `default`, so unwrap it; in browsers/bundlers the
// namespace works directly.
