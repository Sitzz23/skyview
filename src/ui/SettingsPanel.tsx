    ...
    <>
      ...
      <aside className={`panel ${open ? "open" : ""}`} aria-hidden={!open}>
        <header className="topbar">
          ...
          <div className="stat">{status ? `${status.count} overhead` : "—"}</div>
        ...
        <main>
          <Section title="Location">
            ...
            <Row label="Radius" hint="how far out to watch">
              <Slider value={cfg.radiusMiles} min={1} max={50} step={1} unit="mi"
          ...
          <Section title="Overlays">
            ...
            <Row label="Airport runways" hint="SFO geometry, when in view">
          ...
          <Section title="Advanced">
            <Row label="Rotation" hint="rotate the whole field">
              <Slider value={cfg.rotationDeg} min={0} max={355} step={5} unit="°"
                onChange={(v) => set({ rotationDeg: v })} />
            </Row>
            <Row label="Mirror horizontally" hint="planetarium-style E/W flip">
          ...
          <footer className="credits">
            Flight data <a href="https://airplanes.live" target="_blank" rel="noreferrer">airplanes.live</a>
            {" · "}routes <a href="https://www.adsbdb.com" target="_blank" rel="noreferrer">adsbdb</a>
            {" · "}TLEs <a href="https://celestrak.org" target="_blank" rel="noreferrer">CelesTrak</a>
            <br />
            Based on <a href="https://github.com/cpaczek/skylight" target="_blank" rel="noreferrer">
              Skylight
            </a>{" "}
            by cpaczek (MIT)
          </footer>
